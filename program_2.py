...
def display_larger_than_n_list(n, n_list):
    ...
    new_list = [value for value in n_list if value > n]
    print(f'In display_larger_than_n_list these are the values larger than {n}: {new_list}')
